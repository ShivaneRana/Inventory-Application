...
validationObject = [
    body("publisher_name").trim()
    .matches(/^[a-zA-Z0-9\s]+$/).withMessage("Publisher name only contain alphabet letters or numbers."),
    body("publisher_country").trim()
    .matches(/^[a-zA-Z\s]+$/).withMessage("Publisher country can only contain alphabet letters.")
]
